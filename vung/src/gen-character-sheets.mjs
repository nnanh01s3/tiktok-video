...
const CHARACTER_PROMPTS = {
  momo: {
    ...
    prompt: [
      ...
      "No clothing, natural animal body with fur only.",
      ...
      "Negative: realistic, scary, dark, aggressive, humans, people, clothing, shirts, pants.",
    ].join(" "),
  },
  tiko: {
    name: "Tiko",
    prompt: [
      ...
      "Wearing only round reddish-brown glasses (no other clothing).",
      ...
      "No clothing, no robes, no capes — just natural turtle body with shell and glasses.",
      "White clean background, centered in frame.",
      "Cute 3D Pixar cartoon style, vibrant colors, high detail, smooth texture.",
      "9:16 vertical aspect ratio.",
      "NO TEXT, NO LETTERS, NO WATERMARKS, NO LOGOS.",
      "Negative: realistic, scary, dark, humans, broken shell, clothing, robes, capes.",
    ].join(" "),
  },
  lala: {
    name: "Lala",
    prompt: [
      ...
      "No clothing, natural fox body with beautiful fur patterns only.",
  ...
  bobo: {
    ...
    prompt: [
      ...
      "No clothing, natural bear body with fur only.",
      ...
      "9:16 vertical aspect ratio.",
      "NO TEXT, NO LETTERS, NO WATERMARKS, NO LOGOS.",
      "Negative: realistic, scary, angry, dark, humans, people, dogs, clothing, shirts.",
    ].join(" "),
  },
};
